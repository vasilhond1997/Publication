    ...
    <div class="row">
        <div class="column column-40">
            <div class="center-div">
                <h2>Εισαγωγή πολλαπλών Δημοσιεύσεων</h2>
                <form action="uploadpublications.php" method="POST" name="formupload" enctype = "multipart/form-data">
                    <button id="filechooser" type="button" class="button button-outline" onclick="getFile()">Ανέβασμα αρχείου</button>    
                    <div style='height: 0px;width:0px; overflow:hidden;'>
                        <input name="upfile" id="upfile" type="file" onchange="sub(this)" />
                    </div>
                    <h3>OR</h3>
                    <label for="biburl">Πληκτρολογήστε ένα URL</label>
